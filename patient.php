...
<div class="wrapper col2">
  <div id="breadcrumb">
  <ul>
      <li class="first">Edit Patient Profile</li>
  </ul>
  </div>
</div>
  ...
  <div id="container">
    ...
    <table border="3">
      <tbody>
        <tr>
          <td>Patient Name</td>
          <td><input type="text" name="patientname" id="patientname"  value="<?php echo $rsedit[patientname]; ?>"/></td>
        </tr>
<?php
if(isset($_GET[editid]))
{
...
?>
        ...
        <tr>
          <td colspan="2"><center><input type="submit" name="submit" id="submit" style="border-radius: 25px; font-size:15px; font-weight: bold;"  value="Submit" /></center></td>
        </tr>
      </tbody>
    </table>
    </form>
