  ...
  <div id="container">
    ...
    <table border="3">
     <thead>
        ...
        <tr>
          <td>Paid Date</td>
          <td><input type="date" value="<?php echo date("Y-m-d"); ?>" name="date" id="date"></td>
        </tr>
        <tr>
          <td>Paid Time</td>
...
<thead>
  <tr>
          <td colspan="2"><center><a href='patientreport.php?patientid=<?php echo $_GET[patientid]; ?>'><strong>View Patient Report>></strong></a></center></td>
        </tr>
      </thead>
    </table>
    <p>&nbsp;</p>
