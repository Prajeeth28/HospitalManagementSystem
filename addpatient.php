...
<div class="wrapper col4">
  <div id="container">
    ...
    <tbody style="color:black">
        <tr>
          <td>Patient Name</td>
          <td><input type="text" name="patientname" id="patientname"  placeholder="Enter Patient Name" value="<?php echo $rsedit[patientname]; ?>"/></td>
        </tr>
<?php
if(isset($_GET[editid]))
{
...
?>
        ...
        <tr>
          <td colspan="2"><center><input type="submit" name="submit" style="border-radius: 25px; font-size:16px; font-weight: bold;" id="submit" value="Submit" /></center></td>
		</tr>
      </tbody>
    </table>
    </form>
